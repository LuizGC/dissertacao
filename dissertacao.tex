...
\resumo{As redes veiculares \emph{ad hoc} (\emph{Vehicular Ad Hoc Networks} - VANETs) são redes com alta mobilidade. Os veículos podem se comunicar um com os outros ou com infraestrutura na estrada. O objetivo desse trabalho é analisar o desempenho de agentes de software em redes veiculares ad hoc e híbridas.}

\resumoingles{Vehicular Ad Hoc Networks - VANETs are networks with high mobility. The vehicles can communicate with each other or with the road infrastructure.The vehicles can communicate with each other or with the road infrastructure . The aim of this study is to analyze the performance of software agents in vehicular ad hoc networks and hybrid.}
